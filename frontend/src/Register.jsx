...
function Register({ successJob, token }) {
  ...
  const register = async () => {
    ...
    if (!email) { setError('Please enter a valid email address'); triggerShake(); return; }
    if (!password) { setError('Please enter a password'); triggerShake(); return; }
    if (!confirmPassword) { setError('Please confirm your password'); triggerShake(); return; }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-800 px-4 overflow-hidden relative">
      ...
      <div className="w-full max-w-sm animate-fade-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">BigBrain</h1>
